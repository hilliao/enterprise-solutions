...
public class OAuth2 {
    ...
    // using local file storage isn't recommended
    ...
    /**
     * Expects an Authentication Code, then makes an authenticated request for user's profile information
    ...
    // return a list of datasets in a project
    public List<String> getDatasets(GoogleCredentials gCredentials, String projectId) {
    ...
    // get user's email based on access token
