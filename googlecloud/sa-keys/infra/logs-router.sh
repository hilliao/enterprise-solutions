...
FILTER="resource.type=\"global\" log_name=\"projects/$PROJECT_ID/logs/${PWD##*/}-audit\""
...
echo "Grant $writer_SA bigquery dataeditor role in dataset $DATASET in project $PROJECT_ID"