...
--service-account=$SA \
--set-env-vars SECRET_MANAGER_PROJECT_ID=test-vpc-341000,SECRET_NAME_YH_API_KEY=X-RapidAPI-Key,BUCKET=test-vpc-341000,FOLDER=quotes,PROJECT_ID=$PROJECT_ID && \
